...
# input raw data
steps_gf <- read.csv(paste0(main_dir, "data/", "gfsteps.csv"), header = TRUE)
steps_jb <- read.csv(paste0(main_dir, "data/", "jbsteps.csv"), header = TRUE)
users_info <- read.csv(paste0(main_dir, "data/", "users.csv"), header = TRUE)

suggestions_dat <- read.csv(paste0(main_dir, "data/", "suggestions.csv"), header = TRUE)
